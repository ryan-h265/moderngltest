...
void main(){
    ...
    // DEBUG MODE: Visualize shadows and lighting
    ...
    // f_color=vec4(vec3(light_intensity*.1),1.);return;// Show light intensity (scaled)
    // f_color=vec4(vec3(NdotL),1.);return;// Show NdotL (surface angle)
